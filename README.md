...
- **Angle** - the geometric parameter defining the shape of the rocker sill section (denoted as **$\alpha$**)
- **Thickness** - the component parameter defining the panel thickness (denoted as **t**)
