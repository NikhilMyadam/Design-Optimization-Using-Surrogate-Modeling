...
if os.path.isdir('Model_data_100degrees') == True:
  print("Directory already exist")
else:
    os.mkdir('Model_data_100degrees') #  desired directory name
    print("Created a directory - Model_data_100degrees")

print("Current working directory: {0}".format(os.getcwd()))
os.chdir(r"<PATH_TO_PROJECT>/Model_data_100degrees")
print("Current working directory: {0}".format(os.getcwd()))

# Start the loop for the modeling database i.e. myModel

Iterations = 17 # number of models with flange angle 100 degrees
...
def fe_model(i):
	...
	myPoint3 = (-0.05, 0.061272)
	myPoint4 = (-0.05, -0.061272)
	...
	myPoint9 = (0.05, 0.061272)
	myPoint10 = (0.05, -0.061272)
	...
	mdb.saveAs('Model_100degrees.cae')
...
with open('model_database_100degrees_dynamic_impact_sims.csv','wb') as testfile:
