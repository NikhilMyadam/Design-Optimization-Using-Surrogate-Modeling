...
if os.path.isdir('Model_Data_96degrees') == True:
  print("Directory already exist")
else:
    os.mkdir('Model_Data_96degrees') #  desired directory name
    print("Created a directory - Model_Data_96degrees")

print("Current working directory: {0}".format(os.getcwd()))
os.chdir(r"<PATH_TO_PROJECT>/Model_Data_96degrees")
print("Current working directory: {0}".format(os.getcwd()))

# Start the loop for the modeling database i.e. myModel

Iterations = 17 # number of models with flange angle 96 degrees
...
def fe_model(i):
	...
	myPoint3 = (-0.05, 0.064797)
	myPoint4 = (-0.05, -0.064797)
	...
	myPoint9 = (0.05, 0.064797)
	myPoint10 = (0.05, -0.064797)
	...
	mdb.saveAs('Model_96degrees.cae')
...
with open('model_database_96degrees_dynamic_impact_sims.csv','wb') as testfile:
